...
configs = {
    'seating': dict(
        ...
        hero_sub='The right sofa does not just fill a room. It defines it. It is where mornings are planned and evenings are surrendered. Where conversations stretch past midnight and Sunday afternoons disappear without apology.',
        # Narrative
        narrative_eyebrow='Why It Matters',
        narrative_title='We believe a sofa should outlast<br>the device you are reading this on.',
        narrative_p1='Most sofas are built to a price point, not a standard. The average lifespan of a mass-market sofa is seven years — less than a refrigerator, less than a washing machine, less than the phone in your pocket. We think that is absurd. A sofa is the largest piece of furniture most people will ever buy. It should be the last one they buy for a very long time.',
        narrative_p2='Every SIMIER seat begins with a kiln-dried hardwood frame assembled with reinforced corner blocks and double-doweled joints. Our suspension systems use eight-way hand-tied coils or sinuous springs — chosen per design, not per cost spreadsheet. Foam densities are specified cushion by cushion, because the way you sit in an armchair is not the way you sink into a three-seater after a long week.',
        narrative_p3='Then there is the upholstery. We source from Italian mills that have been weaving for generations. Performance weaves for households with children and pets. Velvets and linens for spaces that prioritize texture and touch. Every fabric is tested for 40,000+ double rubs — which, in plain English, means it will still look good when your kids are old enough to borrow the car.',
        # Featured picks
        featured_eyebrow='Featured Picks',
        featured_title='Four places to start.',
        # Materials spotlight
        mat_title='A closer look at the materials.',
        mat_p1='Italian-milled performance linen. Eight-way hand-tied springs. Solid walnut legs, each hand-oiled and burnished to a depth that catches light differently at every hour of the day. These are the details that separate a SIMIER piece from everything else on the market — and they are details you will notice every single day.',
        mat_p2='Our foam is CertiPUR-US certified. Our wood is FSC-sourced. Our finishes are low-VOC. We do not make a big deal about this because we believe it should be the baseline, not the exception. But we mention it here because someone has to.',
        # CTA
        cta_title='Ready to find your seat?',
        cta_text='Browse the full seating collection online, or contact us for a custom consultation. Every piece is made to order in our Guangdong workshop.',
    ...
    'dining': dict(
        ...
        hero_sub='A dining table is never just a table. It is the stage for Tuesday-night spaghetti and Saturday-night dinner parties. It holds homework and laptops, birthday cakes and condolence cards. It sees your family at their best, their worst, and their most unguarded.',
        narrative_eyebrow='Why It Matters',
        narrative_title='The table is the hardest-working<br>piece of furniture you own.',
        narrative_p1='Think about everything your dining table does in a single week. Breakfast for one. Lunch over email. Afternoon homework. Evening dinner for four. Weekend brunch that stretches into dinner. It holds hot plates and cold drinks, elbows and laptops, candlelight and chaos. Most furniture gets to do one thing well. A dining table has to do everything.',
        narrative_p2='Our tables are cut from solid hardwood slabs — American oak, black walnut, and ash — each board selected for grain character and structural stability. The finish is a hand-applied matte lacquer that protects against water rings and heat marks without looking like plastic. Run your hand across the surface. That warmth is real wood. It always will be.',
        narrative_p3='And the chairs. A dining chair has to support a person through a three-hour meal without making them shift in their seat. Our chair frames use the same mortise-and-tenon joinery found in heirloom furniture. Seat depths and back angles are calibrated to actual human bodies — not industry averages from a 1970s textbook.',
        featured_eyebrow='Featured Picks',
        featured_title='Tables, chairs, and the space between.',
        mat_title='Solid wood. Real joinery. No shortcuts.',
        mat_p1='Every tabletop is a single slab or a matched set of boards, bookmatched for symmetry and joined with invisible glue lines. The legs are attached with traditional mortise-and-tenon — a joint that has held furniture together for three thousand years and will hold yours for at least a few decades more.',
        mat_p2='We finish with a hand-rubbed matte lacquer that seals against moisture without creating that plastic-looking gloss you see on mass-produced furniture. The wood continues to breathe. It responds to humidity. It ages. That is not a flaw — it is the whole point.',
        cta_title='Bring everyone to the table.',
        cta_text='Explore our dining collection — from intimate two-person sets to tables that seat twelve.',
    ...
    'bedroom': dict(
        ...
        hero_sub='The average person sleeps for twenty-six years. Twenty-six years of eyes closed, breathing slow, the weight of the day lifting. The bed that holds you through all of that — through the restless nights and the rainy Sunday mornings — should be more than a metal frame and a box spring.',
        narrative_eyebrow='Why It Matters',
        narrative_title='Sleep is not a luxury.<br>Neither should be the furniture that supports it.',
        narrative_p1='Walk into any furniture showroom and you will find beds that creak on day one. Frames assembled with cam locks that loosen with every toss and turn. Headboards attached with brackets designed for shipping convenience, not structural integrity. The bed becomes something you tolerate rather than something you look forward to.',
        narrative_p2='We build beds differently. Every SIMIER bed frame starts with a solid hardwood platform — no plywood, no particle board, no engineered shortcuts. Center support legs run the full length of the mattress area and are screwed directly into the frame, not clipped on as an afterthought. The result is absolute silence. Roll over. Get up at 3 a.m. Your partner will not feel a thing.',
        narrative_p3='Our headboards are upholstered in the same Italian fabrics we use on our sofas — performance weaves and textured linens that invite you to lean back with a book. Nightstands are solid wood with soft-close drawers and a felt-lined top drawer for the things you want within reach but out of sight.',
        featured_eyebrow='Featured Picks',
        featured_title='The foundation of every morning.',
        mat_title='Built silent. Built solid. Built to stay.',
        mat_p1='Kiln-dried hardwood frames. Steel-reinforced center supports. Slat systems engineered to distribute weight evenly across the entire mattress surface. These are not marketing bullet points — they are the engineering decisions that determine whether your bed is a sanctuary or a source of low-grade irritation every single night.',
        mat_p2='Our finishes are low-VOC and water-based. No off-gassing. No chemical smell. Just the quiet presence of well-made furniture in the room where you are most vulnerable.',
        cta_title='Rest better, starting tonight.',
        cta_text='Discover beds, headboards, and nightstands — every piece made to order in our Guangdong workshop.',
    ...
    'storage': dict(
        ...
        hero_sub='Storage is not just about hiding clutter. It is about honoring the objects you have chosen to live with — the books, the glassware, the record collection, the ceramic bowl you brought back from that trip. These things tell the story of who you are. They deserve furniture that tells the same story.',
        narrative_eyebrow='Why It Matters',
        narrative_title='Storage should never be<br>an afterthought.',
        narrative_p1='Most storage furniture is designed from the outside in — a pretty facade hiding particle-board shelves and stapled back panels. We design from the inside out. Our cabinets and sideboards start with the same solid hardwood, the same joinery techniques, and the same finishing process as our dining tables and bed frames.',
        narrative_p2='Dovetailed drawers. Adjustable solid wood shelves. Soft-close hardware that catches the door before it slams. Back panels that are actually finished — because someday you might place that cabinet in the middle of a room, and the back will be visible. These are details you do not think about when you buy. You notice them every day for the next twenty years.',
        narrative_p3='Our coffee tables and side tables follow the same philosophy. Solid wood tops. Mortise-and-tenon leg joints. Hand-applied finishes that develop a patina rather than peeling away. A coffee table should not wobble when you put your feet up. Ours do not.',
        featured_eyebrow='Featured Picks',
        featured_title='Storage that stands on its own.',
        mat_title='Inside and out, built to the same standard.',
        mat_p1='Solid wood drawer boxes with dovetail joinery. Full-extension drawer glides rated for 100 pounds. Adjustable shelf pins in solid brass. These are the invisible details that separate a piece of furniture from a disposable container with doors.',
        mat_p2='Every surface — front, back, top, bottom, inside the drawers — is sanded and finished. Because we do not know which side will face the room, and neither should you have to think about it.',
        cta_title='Give your things the home they deserve.',
        cta_text='Explore cabinets, sideboards, coffee tables, and more. All made to order.',
    ...
    'sendayi': dict(
        ...
        hero_sub='Not a revival. Not a reproduction. A continuation. Sen Yi Da Shi carries forward the craft traditions of Song and Ming dynasty furniture — Ruanti hand-weaving, wild Indonesian rattan, mountain palm fiber — shaped by artisans who inherited techniques that span a thousand years.',
        narrative_eyebrow='Why It Matters',
        narrative_title='Some crafts are too important<br>to let disappear.',
        narrative_p1='Ruanti — the art of hand-weaving palm and rattan fibers into a tight, breathable seat surface — was the standard for fine Chinese furniture for centuries. Then came the 20th century: Simmons mattresses, foam cushions, mass production. By the 1990s, the number of artisans still practicing Ruanti could be counted on two hands.',
        narrative_p2='Sen Yi Da Shi was born from a simple conviction: that this craft deserves to live. Our founder Maggie spent two years traveling across southern China, finding the last remaining palm and rattan weavers, learning their techniques, and adapting them to furniture designed for contemporary homes. The result is a collection that feels both ancient and entirely now.',
        narrative_p3='Every piece uses traditional mortise-and-tenon joinery — no metal fasteners, just wood interlocking with wood. Materials are sourced with obsessive care: wild rattan from Indonesian volcanic soil, mountain palm fiber mentioned in the Ming Dynasty Compendium of Materia Medica, solid elm and black walnut finished with natural wood wax oil.',
        featured_eyebrow='Featured Picks',
        featured_title='Where to begin.',
        mat_title='Natural materials. Ancient techniques. Modern living.',
        mat_p1='Wild Indonesian rattan grows on volcanic soil under equatorial sun — the thickest vines reach 6 centimeters in diameter, the longest exceed 180 meters. Mountain palm fiber has been used for waterproof cables on naval warships and, as the World Health Organization recognized in the 1970s, makes the most breathable, mite-free mattress material known.',
        mat_p2='Our finishes contain zero formaldehyde. Our wood is FSC-certified. Our artisans have an average of fifteen years of experience. These are not marketing claims — they are the terms of engagement for every piece that leaves our workshop.',
        cta_title='Step into a thousand years of craft.',
        cta_text='Visit the complete Sen Yi Da Shi section with detailed product pages, material deep-dives, and brand stories.',
        cta_link='../sendayi.html', cta_label='Explore Sendayi',
        asset_cat='森怡大时',
    ),
}
